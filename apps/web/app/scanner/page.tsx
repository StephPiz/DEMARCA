...
export default function ScannerPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6fb] p-4 md:p-6">
      <Topbar title="Escaner Operativo" storeName={storeName} />

      <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
        <section className="rounded-2xl bg-white p-5 shadow">
          <h2 className="text-xl font-bold text-[#141a39]">7.1 Escaneo Universal</h2>
          <p className="mt-1 text-sm text-gray-600">Busca por EAN real y si no existe revisa alias.</p>
          ...
          <div className="mt-4 flex gap-2">
            <input
              ...
              className="h-11 flex-1 rounded-xl border border-gray-300 px-3 outline-none focus:border-[#4449CD]"
              onKeyDown={(e) => {
          ...
          {scanResult && !scanResult.found ? (
            <div className="mt-4 rounded-xl border border-[#F0D5D5] bg-[#FFF7F7] p-4">
              ...
              <button
                ...
                className="mt-3 h-10 rounded-lg bg-[#4449CD] px-4 text-white disabled:opacity-60"
              >
        ...
        <section className="rounded-2xl bg-white p-5 shadow">
          <h2 className="text-xl font-bold text-[#141a39]">7.2 Entradas (Recepcion)</h2>
          <p className="mt-1 text-sm text-gray-600">Selecciona almacen/ubicacion, confirma y crea lote + movimiento.</p>
          ...
          <input
            ...
            className="mt-3 h-11 w-full rounded-xl border border-gray-300 px-3"
            placeholder="Nota"
          />
          ...
          {receiveError ? <p className="mt-3 text-sm text-red-600">{receiveError}</p> : null}
          {receiveMessage ? <p className="mt-3 text-sm text-emerald-700">{receiveMessage}</p> : null}
        </section>
      </div>
    </div>
  );
